---
title: "Дифференциал композиции ФМП"
tags:
  - понятие
---
...
$f:D\to \mathbb{R}^{m},\ g:E\to \mathbb{R}^{l},\ f(D)\subset E\subset \mathbb{R}^{m},\ D\subset \mathbb{R}^{n},\ a \in \mathrm{Int}\,D,\ f(a) \in \mathrm{Int}\,E,\ f$ [[knowledge/math/analysis/Дифференцируемость ФМП|дифф.]] в т. $a$, $g$ дифф. в т. $f(a)$
...
\end{gathered}
$$
(см. [[knowledge/math/analysis/Дифференциал ФМП|Дифференциал ФМП]])
# Док-во
