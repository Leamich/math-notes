...
$$
$f(x)=\ln x, f''(x)= -\frac{1}{x^{2}}$. Тогда по [[knowledge/math/analysis/Формула Эйлера-Маклорена для второй производной|Формула Эйлера-Маклорена для второй производной]]
...
[[knowledge/math/analysis/Формула Валлиса#Следствие|Знаем]], что $\binom{2n}{n}\sim \frac{4^{n}}{\sqrt{\pi n}}$
$$
