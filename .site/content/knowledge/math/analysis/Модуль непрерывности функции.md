---
title: "Модуль непрерывности функции"
tags:
  - понятие
---
...
5. Если $f$ [[knowledge/math/analysis/Липшицева функция|липшицева]] с конст. $M$, то $\omega_{f}(\delta)\leq M\delta$
6. $f$ [[knowledge/math/analysis/Равномерная непрерывность|равн. непр.]] на $E$ $\iff \lim\limits_{ \delta \to 0+ }\omega_{f}(\delta)=0$ (т.е. $\omega_{f}$ непр. в т. 0)
>[!note]- Док-во
