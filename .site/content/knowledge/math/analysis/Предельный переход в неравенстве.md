...
Тогда рассмотрим $\varepsilon=\frac{|b-a|}{3}$, тогда по [[knowledge/math/analysis/Лемма о двух сходящихся последовательностях|лемме]] $\exists N\ \forall n\geq N: \begin{cases}|x_{n}-a|<\varepsilon\\|y_{n}-b|<\varepsilon\end{cases}$
