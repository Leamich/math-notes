---
title: "Теорема об интегрировании равномерно сходящейся последовательности"
---
...
$f_{n},f:[a,b]\to \mathbb{R}$ непр. (см. [[knowledge/math/analysis/Равномерная сходимость функ последовательностей|Равномерная сходимость функ последовательностей]])
...
$f_{n}:=\sum\limits_{k=1}^{n} u_{k}(x)\rightrightarrows f:=\sum\limits_{k=1}^{\infty}u_{k}$ — непр. (из равн. сх., см. [[knowledge/math/analysis/Перестановка суммы и предела#Следствие|th]])
...
А последнее стремится к нулю по [[knowledge/math/analysis/Критерий равномерной сходимости|th]].
