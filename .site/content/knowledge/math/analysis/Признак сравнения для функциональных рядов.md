---
title: "Признак сравнения для функциональных рядов"
---
...
2. [[knowledge/math/analysis/Признак Вейерштрасса|Признак Вейерштрасса]]
# Док-во

([[knowledge/math/analysis/Критерий Коши для равномерной сходимости ряда|кр. Коши]])
$$
