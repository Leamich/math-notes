---
title: "Теорема о гармонической сумме простых чисел"
---
...
$P_{n}\geq H_{n}$, где $P_{n}:=\prod\limits_{k=1}^{n} \frac{1}{1-\frac{1}{p_{k}}}$ ([[knowledge/math/analysis/Пример для беск произведения|Пример для беск произведения]])
$$
