...
$f \in C[a, b]$ $\implies f$ [[knowledge/math/analysis/Равномерная непрерывность|равн. непр.]] на $[a, b]$

>[!note]- Важно, что именно отрезок
>Для $x^{2}$ мы [[knowledge/math/analysis/Равномерная непрерывность#^6fab41|поняли]], что на $[0;+\infty)$ нет равн. непр. $\implies$ отрезок нельзя заменить на луч.
>
