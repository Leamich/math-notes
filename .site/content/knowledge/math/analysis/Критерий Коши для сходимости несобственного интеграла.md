---
title: "Критерий Коши для сходимости несобственного интеграла"
tags:
  - понятие
---
...
$\impliedby:$ $F(y):=\int\limits_{a}^{y}f$. $\forall \varepsilon>0: \exists c \in (a,b)\ \forall A,B \in (c,b)$ $\implies |F(B)-F(A)|<\varepsilon$. По [[knowledge/math/analysis/Критерий Коши для функций|критерию Коши для предела ф-й]] сущ-ет конечный $\lim\limits_{ B \to b- }F(B)$ — это и есть несобств. интеграл.
