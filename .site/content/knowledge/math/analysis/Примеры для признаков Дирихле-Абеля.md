---
title: "Примеры для признаков Дирихле-Абеля"
tags:
  - понятие
---
...
$$
$\int\limits_{1}^{+\infty}\frac{dx}{x^{p}}$ — сх-ся $\implies \int\limits_{1}^{+\infty} \frac{\sin x}{x^{p}}dx$ — сх-ся абсол. по [[knowledge/math/analysis/Признак сравнения|призн. сравнения]].
