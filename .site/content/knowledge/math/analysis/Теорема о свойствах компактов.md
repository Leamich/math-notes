---
title: "Теорема о свойствах компактов"
tags:
  - понятие
---
...
$(X, \rho)$ — метр. пр-во.
1. $K\subset Y\subset X$. Тогда $K$ — [[knowledge/math/analysis/Компакт|Компакт]] в $(X, \rho) \iff K$ — компакт в $(Y, \rho)$
2. $K$ — компакт $\implies$ $K$ — замкнуто и огр.
3. [[knowledge/math/analysis/Замкнутое множество|Замкнутое]] подм-во компакта — компакт.
# Док-во
## Пункт 1
...
![[assets/images/Pasted image 20250403014519.png]]

$x \in K$. Возьмём такое $r_{x}>0: B_{r_{x}}(x)\cap B_{r_{x}}(a)=\varnothing$. $K\subset \bigcup\limits_{x \in K}B_{r_{x}}(x)$ — [[knowledge/math/analysis/Открытое покрытие|Открытое покрытие]]. 
