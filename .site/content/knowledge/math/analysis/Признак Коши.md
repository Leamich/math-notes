...
$$
Тогда $\sum\limits_{n=N}^{\infty}a_{n}$ сх-ся по [[knowledge/math/analysis/Признак сравнения для рядов|призн. сравн.]] (добавим конечн. число $a_{n}$ — сход-ть не испортится).
## Пункт 2
