...
[[knowledge/math/analysis/Линейный оператор|Оператор]] ограничен, если его [[knowledge/math/analysis/Норма линейного оператора|норма]] конечна.

>[!note]- Огр. операторы $X\to Y$ образ вект. пр-во

>[!note]- Огр. оператор $\neq$ [[knowledge/math/analysis/Ограниченная функция в метр пр-ве|огр. отображение]]
