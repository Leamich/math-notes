---
title: "Свойства криволинейного интеграла II рода"
---
...
$\omega=f_{1}dx_{1}+\dots+f_{n}dx_{n}$ (см. [[knowledge/math/analysis/Дифференциальная форма 1-го порядка|Дифференциальная форма 1-го порядка]]), $\gamma:[a,b]\to \mathbb{R}^{n}$
$\int\limits_{\gamma} \omega:=\int\limits_{a}^{b}\sum\limits_{k=1}^{n}f_{k}(\gamma(t))\gamma'_{k}(t)\,dt$ (см. [[knowledge/math/analysis/Криволинейный интеграл II рода|Криволинейный интеграл II рода]])
...
>[!note] Док-во 4-5 из (3) + [[knowledge/math/analysis/Свойства интеграла по длине дуги|Свойства интеграла по длине дуги]]
