---
title: "Наиб и наим значения кв формы на сфере"
tags:
  - понятие
---
...
Пример для [[knowledge/math/analysis/Метод неопределённых множителей Лагранжа|Метод неопределённых множителей Лагранжа]]
...
[[knowledge/math/analysis/Функция Лагранжа|Функция Лагранжа]] $F(x)=Q(x)-\lambda \Phi(x),\ \lambda \in \mathbb{R},\ \nabla F=0$
$$
