...
6. Пусть $E\subset \mathbb{R}^{m}$, т.ч. $\forall\varepsilon>0: \exists A_{\varepsilon},B_{\varepsilon}\in \mathcal{L}^{m}$, т.ч. $A_{\varepsilon}\subset E\subset B_{\varepsilon}$ и $\lambda_{m}(B_{k}\setminus A_{k})<\varepsilon$. Тогда $E\in \mathcal{L}^{m}$ (это св-во любой [[knowledge/math/measure/Полная мера|Полная мера]])
>[!note]- Док-во
...
>[!note]- Существуют неизмеримые м-ва $\mathcal{L}^{m}\neq 2^{\mathbb{R}^{m}}$ (см. [[knowledge/math/measure/Пример неизмеримого множества для одномерных случаев|Пример неизмеримого множества для одномерных случаев]])
