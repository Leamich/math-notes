---
title: "Теорема Каратеодори о сужении субмеры"
---
...
$\nu$ — [[knowledge/math/measure/Субмера|Субмера]]

Тогда 
1. $\nu$-[[knowledge/math/measure/Измеримое множество|измеримые мн-ва]] образуют $\sigma$-алгебру
2. Сужение $\nu$ на эту $\sigma$-алг. — [[knowledge/math/measure/Полная мера|Полная мера]]
## Док-во

$\mathcal{A}$ — семейство всех $\nu$-измер. мн-в.

>[!note] Будем проверять, что
> $\forall A:\nu A\geq \nu(A\cap E)+\nu(A\setminus E)$, см. [[knowledge/math/measure/Измеримое множество|Измеримое множество]]
...
> $\mathcal{A}$ — [[knowledge/math/measure/Симметричная система подмножеств|симм.]], т.е. $E \in \mathcal{A}\implies(X\setminus E)\in \mathcal{A}$
...
$\nu |_{\mathcal{A}}$ — мера, т.к. это объем + сч. полуадд. ([[knowledge/math/measure/Теорема о счётной полуаддитивности|Теорема о счётной полуаддитивности]])
