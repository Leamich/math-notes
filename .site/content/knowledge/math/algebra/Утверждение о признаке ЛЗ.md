---
title: "Утверждение о признаке ЛЗ"
tags:
  - понятие
---
...
Тогда $v_{1}, \dots, v_{n}$ — ЛЗ (не [[knowledge/math/algebra/Линейная независимость|ЛНЗ]]) $\iff \exists i: v_{i} \in \langle v_{1},\dots,v_{i-1},v_{i+1},\dots, v_{n} \rangle$
