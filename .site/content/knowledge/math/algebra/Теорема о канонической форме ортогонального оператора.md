---
title: "Теорема о канонической форме ортогонального оператора"
---
...
След-е усл-я $\iff$
1. $\mathscr{A}:V\to V$ — [[knowledge/math/algebra/Ортогональный (унитарный) оператор|орт.]] ($V$ — евкл.)
...
Сразу считаем, что $V=\mathbb{R}^{n},\ \mathscr{A}(x)=Ax$ $\mapsto V_{\mathbb{C}}=\mathbb{C}^{n},\ A^{\mathbb{C}}(x)=Ax$ $\implies \mathscr{A}^{\mathbb{C}}$ — унит. $\implies$ по [[knowledge/math/algebra/Теорема о канонической форме унитарного оператора|Теорема о канонической форме унитарного оператора]] $\exists$ ОНБ из с. столбцов в $\mathbb{C}^{n}$. 
