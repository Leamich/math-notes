...
1. $A \in M_{m, n}(K)\implies \exists$ элем-ты $e_{1}, \dots, e_{k}$ ([[knowledge/math/algebra/Трансвекция|трансв.]]/[[knowledge/math/algebra/Дилатация|дилатация]]): $e_{1}\dots e_{k}A=\begin{pmatrix}a_{11} & *&* \\ & a_{22} & * \\&&\dots\end{pmatrix}$
...
Индукция по $n$ (как в [[knowledge/math/algebra/Лемма о линейной зависимости линейных комбинаций (ЛЗЛК)|ЛЗЛК]]). 
