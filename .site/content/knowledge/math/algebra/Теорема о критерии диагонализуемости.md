---
title: "Теорема о критерии диагонализуемости"
tags:
  - понятие
---
...
1. $\forall \lambda: m_{a}(\lambda)\geq m_{g}(\lambda)$ ([[knowledge/math/algebra/Алг и геом кратность собственного числа|Алг и геом кратность собственного числа]])
2. $\mathscr{A}$ — [[knowledge/math/algebra/Диагонализуемый оператор|диаг-ем]] $\iff \chi_{\mathscr{A}}(t)$ раскл. на лин. мн-ли и $m_{a}(\lambda)=m_{g}(\lambda)\ \forall \lambda$
# Док-во
## Пункт 1
