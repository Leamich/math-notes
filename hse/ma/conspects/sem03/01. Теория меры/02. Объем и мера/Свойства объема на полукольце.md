$\mathcal{P}$ — [[Полукольцо]], $\mu$ — [[Объем]] на $\mathcal{P}$
...
$(\tilde{P}\setminus \bigsqcup\limits_{k=1}^{n}P_{k})=\bigsqcup\limits_{j=1}^{m}Q_{j}$, где $Q_{j}\in \mathcal{P}$ (см. [[Теорема о свойствах элементов полукольца]])
