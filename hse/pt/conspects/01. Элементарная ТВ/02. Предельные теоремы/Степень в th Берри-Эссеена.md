...
\begin{gathered}
\mathbb{P}(S_{2n}\leqslant n) - \underbrace{ \frac{1}{\sqrt{2\pi}}\int\limits_{-\infty}^{o} e^{ -x^{2}/2 }\,dx }_{ =\frac{1}{2} }=\\=\mathbb{P}(S_{2n}\leqslant n)-\frac{1}{2}+o\left( \frac{1}{\sqrt{n}} \right)\sim \frac{1}{2\sqrt{\pi n}}
\end{gathered}
\end{gathered}
$$
