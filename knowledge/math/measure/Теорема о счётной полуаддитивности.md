...
$\impliedby: P=\bigsqcup\limits_{k=1}^{+\infty}P_{k}\stackrel{\text{сч. полуадд.}}{\implies}\mu P\leq \sum\limits_{k=1}^{+\infty}\mu P_{k}$, а также $\stackrel{\text{усил. монот.}}{\implies}\mu P\geq \sum\limits_{k=1}^{+\infty}\mu P_{k}$ (см. [[Свойства объема на полукольце]])
